...
*/
public class MsIe11Win7RemoteDriverProvider extends BrowserBase{

    @Override
    public WebDriver createDriver(DesiredCapabilities desiredCapabilities) {
       return createSeleniumGridRemoteDriver("ie", "11.0", Platform.WINDOWS, MsConstants.seleniumGridWinHubAddress);
    }
}
